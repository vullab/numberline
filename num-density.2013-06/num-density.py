...
# TODO erikb uncomment the below
...
def getMaxN(I):
	# return(sum(range(0,I)*6)+1) # TODO erikb uncomment this
...
# pygame.init() # TODO erikb uncomment this
# pygame.event.set_grab(1) # TODO erikb uncomment this
# SCREEN = pygame.display.set_mode((WX,WY), pygame.FULLSCREEN) # TODO erikb uncomment this
pygame.font.init() # TODO erikb delete this
SCREEN = pygame.display.set_mode([WX,WY]) # TODO erikb delete this
...
def quit(signal=False):
	...
	# FILE.close() # TODO erikb uncomment this
	sys.exit(0)
...
def dotCenters(n, Rdot, Rspace):
	...
	I = getMinI(n*scale)
	maxn = getMaxN(I)
	# usei = range(1,maxn+1) # TODO erikb uncomment this
	usei = [x for x in range(1,maxn+1)] # TODO erikb delete this
	random.shuffle(usei)
	usei = usei[0:n]
	dots = []
	for i in usei:
...
def drawDots(dots, Rdot):
	print("drawing dots with radius: {}".format(Rdot)) # TODO erikb delete this
	for txy in dots:
...
for t in range(0,ntrials):
	...
	# vary = random.choice(['area', 'space', 'size']) # TODO erikb uncomment this
	vary = 'size' # TODO erikb delete this
	if vary=='area':
	...
	print("dots: {}".format(dots)) # TODO erikb uncomment this
	drawDots(dots,Rdot)
	pygame.display.update() # TODO erikb added this
	#pygame.display.flip()
