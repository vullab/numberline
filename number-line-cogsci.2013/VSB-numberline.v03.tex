...
As already noted, patterns of bias and variability in estimation arise from both numerical perception and the mapping of these magnitude representations to language. (see Figure \ref{figure-model}). Our proposal is that (1) the slope of the higher portion of this mapping function is variable over time, and (2) uncertainty in this mapping causes it to vary across time, thus introducing additional variability in estimation tasks that increases with numerosity.  
