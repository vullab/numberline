...
![](erikb_block_slope_corrs_participant.png)

Below is the same correlation in slopes by block for model data.

![](erikb_block_slope_corrs_mcmc.png)
...
![**Participant data for 300 trials (24 participants)**](erikb_participant_data.png)
...
![**Sample log likelihood for a given trial**](erikb_loglik_sample.png)
...
![**Sample log posterior estimate for a given trial**](erikb_posterior_sample.png)
...
![**Model performance with 100 calibration trials in each estimate**](erikb_model_n100.png)
...
![**Model performance with 50 calibration trials in each estimate**](erikb_model_n50.png)
...
![**Model performance with 25 calibration trials in each estimate**](erikb_model_n25.png)
...
![**Disparity between model estimates and true numbers shown on each trial**](erikb_model_disparity.png)
...
![**Model MCMC slopes for 300 trials**](erikb_mcmc_slopes.png)
...
![**Sample MCMC experiment data for 300 trials**](erikb_mcmc_fake_participants.png)
...
![**Model slope correlations by block**](erikb_block_slope_corrs_mcmc.png)
...
![**Model slope correlations by trial distance, showing "drift" of model slopes**](erikb_slope_drift_mcmc.png)
...
![**Original participant slope correlations by block**](erikb_block_slope_corrs_participant.png)

Based on the above, we calculate correlation in slopes at greater trial distances across participants.

![**Original participant slope correlations by trial distance, showing "drift" in participant slopes**](erikb_slope_drift_participants.png)
